...
<table width="200" border="1">
  ...
  <tr>
   ...
   <tr>
   <td><a href="Addbreed.php">Add Breed</a></td>
  </tr>
  <tr>
   <td><a href="Department.php">Add Department</a></td>
  </tr>
  <tr>
    <td><a href="Doctor.php">Add Doctors</a></td>
  </tr>
  <tr>
    <td><a href="Slot.php">Add Slots</a></td>
  </tr>
 <tr>
    <td><a href="Viewfeedback.php">ViewFeedbacks</a></td>
  </tr>
  <tr>
    <td><a href="Viewcomplaints.php">ViewComplaints</a></td>
  </tr>
...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="../Assets/Templates/Admin/images/veterinary.png" />
</head>
<body>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="index.html"><img src="../Assets/Templates/Admin/images/petaura4.svg" alt="logo"/></a>
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name"><?php echo $_SESSION['aname'];?>
              </span>
            </a>
    ...
    <a class="nav-link d-flex justify-content-center align-items-center" href="javascript:;">
        <h6 class="date mb-0" id="current-date"></h6>
...
<script>
    ...
    document.getElementById('current-date').innerText = 'Today : ' + formatDate(today);
</script>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Doctor.php">
              ...
              <span class="menu-title">Register Doctors</span>
            </a>
            ...
            <a class="nav-link" href="Addbreed.php">
              <i class="typcn typcn-mortar-board menu-icon"></i>
                      ...
                      <div class="row align-items-center h-100">
                        <div class="col-md-4">
                          <figure class="avatar mx-auto mb-4 mb-md-0">
                            <img src="../Assets/Templates/Admin/images/faces/face20.jpg" alt="avatar">
                          </figure>
                        </div> -->
                        <!-- <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024 <a href="https://www.bootstrapdash.com/" class="text-muted" target="_blank"></a>. All rights reserved.</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-muted"> <a href="https://www.bootstrapdash.com/" class="text-muted" target="_blank"></a> </span>
                    </div>
                </div>    
            </div>        
        </footer>
