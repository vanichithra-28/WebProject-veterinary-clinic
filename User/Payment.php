...
session_start();
	...
	if(isset($_POST["btn_pay"]))
	{
				...
				$a = "update tbl_booking set booking_status='1' ";
				if($con->query($a))
				{
	...
	<style>
		*{
		...
		.name:focus, .dob:focus{
			-webkit-box-shadow:0 0 2px 1px #2832C2;
			-moz-box-shadow:0 0 2px 1px #2832C2;
			box-shadow: 0 0 2px 1px #2832C2;
			border: 1px solid #2832C2;
		}
		.input-box .icon{
			width: 48px;
			display: flex;
